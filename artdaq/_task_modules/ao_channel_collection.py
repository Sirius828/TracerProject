...
from artdaq.constants import (CurrentUnits, VoltageUnits, ChannelType, TerminalConfiguration)
...
class AOChannelCollection(ChannelCollection):
    ...
    def add_ao_current_chan(
            ...
            terminal_config = TerminalConfiguration.DEFAULT, min_val=0.00,
        ...
        if cfunc.argtypes is None:
            ...
            error_code = cfunc(self._handle, physical_channel, terminal_config.value)
        check_for_error(error_code)
    ...
    def add_ao_voltage_chan(
            self, physical_channel, name_to_assign_to_channel="", terminal_config=TerminalConfiguration.DEFAULT,
