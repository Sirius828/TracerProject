...
from artdaq.art_types import CtrFreq, CtrTick, CtrTime
from artdaq.utils import unflatten_channel_string, flatten_channel_string
from artdaq._task_modules.calibration import Calibration
...
class Task(object):
    ...
    def number_of_channels(self):
        ...
        while True:
            ...
            size_or_code = cfunc(
                self._handle, 0x2181, val, temp_size)
    ...
    def _initialize(self, task_handle):
        ...
        self._calibration = Calibration(task_handle)
        self._device = Device(task_handle)
